...
extension Block {
    ...
    func resetNodeLocation(_ node: SCNNode, startLocation: (Int, Int)) {
        ...
        let moveAnimation = SCNAction.move(by: SCNVector3Make(xBy, yBy, zBy), duration: 0)
        let rotationAnimation = SCNAction.rotate(toAxisAngle: SCNVector4Zero, duration: 0)
